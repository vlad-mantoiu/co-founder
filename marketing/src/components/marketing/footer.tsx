...
const insourcedFooterLinks = {
  Platform: [
    { label: "Co-Founder", href: "/cofounder" },
...
const cofounderFooterLinks = {
  Product: [
    { label: "Features", href: "/cofounder/#features" },
    { label: "Pricing", href: "/pricing" },
    { label: "How It Works", href: "/cofounder/how-it-works" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            {isCofounder && (
              <Link
                href="/"
                className="mt-1 ml-10 text-xs text-white/30 hover:text-white/60 transition-colors block"
              >
                by Insourced AI
              </Link>
            )}
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-white/40 hover:text-brand transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
