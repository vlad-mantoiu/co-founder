...
down_revision: Union[str, Sequence[str], None] = '6a8f3f01a56b'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_onboarding_sessions_clerk_user_id'), 'onboarding_sessions', ['clerk_user_id'], unique=False)
