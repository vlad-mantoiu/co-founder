...
class RunnerFake:
    ...
    def _get_realistic_code(self) -> dict[str, FileChange]:
        ...
        Returns 5 FileChange entries:
        - 2 application code files (product model and API routes)
        - 3 workspace deployment files (README.md, .env.example, Procfile)

        All 5 are required to satisfy GENR-03 workspace file contract.
        """
        return {
...
""",
            ...
            "README.md": FileChange(
                path="README.md",
                original_content=None,
                new_content="""# Inventory Tracker

An AI-generated inventory management system for small retail businesses.

## Overview

Track product quantities, log stock adjustments, and receive automatic low-stock
alerts. Designed for retail shop owners with 1-10 employees managing 100-1000 SKUs.
...
| API_KEY        | No       | External API integration key       |
...
- `POST /adjustments` — Log a stock adjustment
- `GET /reports/stock` — View current stock levels

## Generated by AI Co-Founder

This project was generated by the AI Co-Founder platform.
""",
                change_type="create",
            ),
            ".env.example": FileChange(
                path=".env.example",
                original_content=None,
                new_content="""# Copy this file to .env and fill in your values
# Never commit .env to version control

DATABASE_URL=postgresql://user:password@localhost:5432/inventory_tracker
...
""",
            ...
            "Procfile": FileChange(
                path="Procfile",
                original_content=None,
                new_content="web: uvicorn app.main:app --host 0.0.0.0 --port $PORT",
                change_type="create",
            ),
        }
        ...
        return {
            "nodes": [
                # Anchor nodes — verbatim user phrases
                {
                    "id": "a1",
                    "type": "anchor",
                    "label": "dead-simple inventory tracking",
                    "description": "Core product promise extracted directly from founder's words",
                    "status": "validated",
                },
                {
                    "id": "a2",
                    ...
                    "description": "Must-have feature mentioned in 10/12 customer interviews",
                    "status": "validated",
                },
                {
                    "id": "a3",
                    ...
                    "description": "Key technical requirement for multi-location shops",
                    "status": "validated",
                },
                {
                    "id": "a4",
                    ...
                    "description": "Primary automation value — replaces manual monitoring",
                    "status": "validated",
                },
                {
                    "id": "a5",
                    "type": "anchor",
                    "label": "$49/mo",
                    "description": "Validated price point from customer interviews (8/12 willing to pay)",
                    "status": "validated",
                },
                {
                    "id": "a6",
                    ...
                    "description": "Competitive differentiator vs weeks-long ERP onboarding",
                    "status": "validated",
                },
                # Strategy nodes — LLM-derived go-to-market + business model
                {
                    "id": "s1",
                    "type": "strategy",
                    "label": "Go-to-Market: Local Retail Associations",
                    "description": "Partner with regional retail trade groups to reach shop owners at low CAC. Target 3 associations in first 90 days.",
                    "status": "planned",
                },
                {
                    "id": "s2",
                    "type": "strategy",
                    "label": "Go-to-Market: Content Marketing (Inventory Tips)",
                    "description": "SEO-driven blog content targeting 'inventory management for small business' — high intent, low competition keywords.",
                    "status": "planned",
                },
                {
                    "id": "s3",
                    "type": "strategy",
                    "label": "Business Model: $49/mo SaaS per Location",
                    "description": "Per-location pricing scales naturally with customer growth. Average shop has 1.4 locations = $68.60 ARPU.",
                    "status": "planned",
                },
                {
                    "id": "s4",
                    "type": "strategy",
                    "label": "Business Model: 14-Day Free Trial",
                    "description": "Removes purchase risk. Projected 60% trial-to-paid conversion based on time-to-value (< 1 week).",
                    "status": "planned",
                },
                {
                    "id": "s5",
                    "type": "strategy",
                    "label": "Competitive Moat: Depth over Breadth",
                    "description": "Build deeper inventory workflows (lot tracking, cycle counting) that POS systems won't prioritize. Data history creates switching costs.",
                    "status": "planned",
                },
                {
                    "id": "s6",
                    "type": "strategy",
                    "label": "Competitive Moat: Supplier Integrations",
                    "description": "Phase 2 integrations with distributors and wholesalers create network effects POS bundles cannot replicate.",
                    "status": "planned",
                },
                {
                    "id": "s7",
                    "type": "strategy",
                    "label": "Technical Strategy: Offline-First Architecture",
                    "description": "Local-first data model with conflict-free sync. Key differentiator for locations with unreliable WiFi.",
                    "status": "planned",
                },
                {
                    "id": "s8",
                    "type": "strategy",
                    "label": "Expansion: Multi-Location Upsell",
                    "description": "Single-location MVP with frictionless upgrade path. Multi-location is natural expansion vector for existing customers.",
                    "status": "planned",
                },
                {
                    "id": "s9",
                    "type": "strategy",
                    "label": "Customer Success: Weekly Check-in Calls",
                    "description": "High-touch onboarding for first 50 customers. Reduces churn, generates testimonials, surfaces product gaps.",
                    "status": "planned",
                },
            ],
            "edges": [
            ...
            "long_term_roadmap": [
                ...
                },
                {
                    ...
                    "key_features": [
                        ...
                        "Direct supplier reorder integrations",
    ...
    async def generate_app_architecture(self, idea: str, brief: dict, tier: str) -> dict:
        ...
        return {
            ...
            "cost_estimate": {
                ...
                "breakdown": [
                    {
                        "component": "Hosting (Render or Railway)",
                        "cost": "$25-50/mo",
                        "note": "Includes frontend + backend on managed infrastructure. Zero DevOps.",
                    },
                    {
                        "component": "Database (Render PostgreSQL)",
                        "cost": "$7-25/mo",
                        "note": "Starter plan handles first 500 users. Upgrade at 10k rows/day.",
                    },
                    {
                        "component": "Authentication (Clerk)",
                        "cost": "$0-25/mo",
                        "note": "Free for first 10k MAU. Pro plan at $25/mo unlocks custom domain.",
                    },
                    {
                        "component": "Email (Resend)",
                        "cost": "$0-20/mo",
                        "note": "Free tier covers 3k emails/mo. $20/mo for 50k emails (sufficient to 500 users).",
                    },
                    {
                        "component": "Domain + SSL",
                        "cost": "$12-15/yr",
                        "note": "Namecheap or Cloudflare. SSL is free via Let's Encrypt on most hosts.",
                    },
                ],
            },
