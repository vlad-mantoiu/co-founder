...
must_haves:
  truths:
    - "run_command() and run_background() accept optional job_id and phase params and stream stdout/stderr to Redis via LogStreamer"
    - "GenerationService.execute_build() passes job_id to sandbox commands with appropriate phase tags"
